...
DIR_SAVE = '/remote-home/zhanglu/weakly_molecular/data/syn_version5'
...
def generate_key_subgraph_k_regular(d_list = (4, 5, 6), n_list = (4, 5, 6, 7, 8)):
    ans = []
    for d in d_list:
        for n in n_list:
            if (n * d % 2 == 0 and n > d):
...
while True:
    ...
    n = get_random_value(mu = total_number_nodes + 15, sigma = 6, lower_bound = total_number_nodes,
